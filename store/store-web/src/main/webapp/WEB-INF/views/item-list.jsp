	...
	Date.prototype.format = function(pattern) {
		...
		for ( var key in format) {
			...
			if (regExp.test(returnValue)) {
				...
				var replacement = RegExp.$1.length == 1 ? format[key]
						: (zero + format[key])
...
<table id="itemList" title="商品列表"
	data-options="fit:true,fitColumns:true,nowrap:false">
	<!-- <thead>
        <tr>
...
<!-- 定义div作为弹出窗口 -->
<div id="itemEditWindow" title="编辑商品"
